...
aws elasticbeanstalk update-environment --application-name regression-tests --environment-name java-aws-elasticbeanstalk --version-label $now --option-settings file:///apps/options.json ; \
sleep 40 ; \
