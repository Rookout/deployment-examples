...
aws lambda create-function \
            ...
            --runtime nodejs14.x \
            --environment Variables="{ROOKOUT_TOKEN=$ROOKOUT_TOKEN,ROOKOUT_LABELS='regression_test:node_aws_lambda_regression_test',ROOKOUT_LOG_TO_STDERR=1,ROOKOUT_DEBUG=1}" \
            --timeout 25 \
