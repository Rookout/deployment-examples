...
2. Add our 2 .ebextensions standalone config scripts [available here](https://github.com/Rookout/deployment-example/tree/master/java-elasticbeanstalk/.ebextensions)
